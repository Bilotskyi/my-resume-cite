...
const tabletMenuBtn = document.querySelector("#tablet-menu-btn");
...
const modals = [mobileMenu, tabletMenu, myVideoModal];
const buttons = [mobileMenuBtn, tabletMenuBtn, myVideoBtn];
...
// const callbackSubmit = document.querySelector(".callback-form-submit");
// const modalThanks = document.querySelector("#thanks");
// const modalThanksCloseBtn = document.querySelector(".modal-thanks-close-btn");
